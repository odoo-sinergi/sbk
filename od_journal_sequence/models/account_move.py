...
class AccountMove(models.Model):
    ...
    def _post(self, soft=True):
        ...
        for move in to_post:
            ...
            ## Start Changes by yunus@sinergidata.co.id, damongrmi@gmail.com 2023-08-10 ##
            ## Handle force_date when there are more than 1 picking_id in this stock_move
            picking_ids = self.stock_move_id.picking_id
            if picking_ids:
                date_l = []
                for picking in picking_ids:
                    if picking.force_date:
                        date_l.append(picking.force_date)
                if len(date_l) > 0:
                    date = sorted(date_l, reverse=True)[0]
                    if date != move.date:
                        move.date = date
            ## Original code ##
            ...
            #     if date != move.date:
            #         move.date = date
            ## End Changes by yunus@sinergidata.co.id, damongrmi@gmail.com 2023-08-10 ##
